...
| birthdate | DATE | The date of birth of the customer, formatted as YYYY-MM-DD (eg., 2005-04-15). |
...
| maintenance_requied | NVARCHAR(50) | Indicates whether the product requires maintenance (e.g.,'Yes','No') |
| cost | INT | The cost or base price of the product, measured in monetary units. |
| product_line | NVARCHAR(50) | The specific product line or series to which the product belongs (eg., Road, Mountains |
| start_date | DATE | The date when the product became available foe sale or use, stored in |
